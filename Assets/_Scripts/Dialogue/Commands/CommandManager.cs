...
namespace Commands
{
    public class CommandManager : MonoBehaviour
    {
        ...
        public const string DATABASE_CHARACTES_BASE = "characters";
        public const string DATABASE_CHARACTES_SPRITE = "characters_sprite";
        public const string DATABASE_CHARACTES_LIVE2D = "characters_live2D";
        public const string DATABASE_CHARACTES_MODEL3D = "characters_model3D";
        public static CommandManager instance { get; private set; }
        // private static Coroutine process = null;
        // public static bool isRunningProcess => process != null;
        private CommandDatabase database;
        private Dictionary<string, CommandDatabase> subDatabases = new Dictionary<string, CommandDatabase>(); // will have subdatabase for each character type
        ...
        private CoroutineWrapper ExecuteSubCommand(string commandName, string[] args)
        {
            ...
            if (subDatabases.ContainsKey(databaseName))
            {
                ...
                {
                    Debug.LogError($"No command called '{subCommandName}' was found in subdatabse '{databaseName}'");
                    return null;
                }
            }

            // If we've made to this point try to run as a character command
            ...
            Debug.LogError($"No subdatabase called '{databaseName}' exists");
            return null;
        }
        ...
        private CoroutineWrapper ExecuteCharacterCommand(string commandName, params string[] args)
        {
            ...
            CommandDatabase db = subDatabases[DATABASE_CHARACTES_BASE];
            ...
            switch (characterConfigData.characterType)
            {
                ...
                case Character.CharacterType.SpriteSheet:
                    db = subDatabases[DATABASE_CHARACTES_SPRITE];
                    break;
                case Character.CharacterType.Live2D:
                    db = subDatabases[DATABASE_CHARACTES_LIVE2D];
                    break;
                case Character.CharacterType.Model3D:
                    db = subDatabases[DATABASE_CHARACTES_MODEL3D];
                    break;
            }
